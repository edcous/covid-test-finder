...
async function target(){
    ...
    for (var i = 0; i < config.length; i++) {
        ...
        const price = await axios.get('https://redsky.target.com/redsky_aggregations/v1/web/pdp_client_v1?key=ff457966e64d5e877fdbad070f276d18ecec4a01&tcin=' + sku + '&store_id=2255&pricing_store_id=2255&has_financing_options=true&visitor_id=017D3B56C6050201BAB2A842960390FF&has_size_context=true&latitude=37.930&longitude=-90.780&state=MO&zip=63664')
        const stock = res.data.data.product.fulfillment.shipping_options.availability_status != "OUT_OF_STOCK"
        const price = parseFloat(res.data.data.product.price.current_retail)
